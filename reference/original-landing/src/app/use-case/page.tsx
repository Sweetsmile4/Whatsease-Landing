...
const data = {
  ...
  content: {
    ...
    description:
      'Engage customers in real-time by sending automated cart recovery reminders directly through WhatsApp. With up to 60% reduction in abandoned carts, recover lost sales effortlessly and increase your revenue without leaving the app.',
...
function page() {
  return (
    <div>
      ...
      <Statsection />
      <Seamlesscart data={data} />
      <YourCustomerSection data={useCaseData} />
      <SeamlessIntegration />
      {/* <Testimonial /> */}
      <Footer />
    </div>
